...
exports.getMatches = function (config) { return function () { return __awaiter(_this, void 0, void 0, function () {
    var $, liveMatches, upcomingMatches;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, mappers_1.fetchPage(config.hltvUrl + "/matches", config.loadPage)];
            case 1:
                $ = _a.sent();
                ...
                return [2, liveMatches.concat(upcomingMatches)];
        }
    });
}); }; };
