...
exports.getPlayerStats = function (config) { return function (_a) {
    var id = _a.id, startDate = _a.startDate, endDate = _a.endDate;
    return __awaiter(_this, void 0, void 0, function () {
        var options, $, name, ign, image, getInfo, age, country, team, getStats, statistics;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4, mappers_1.fetchPage(config.hltvUrl + "/stats/players/" + id + "/-" + options, config.loadPage)];
                case 1:
                    $ = _b.sent();
                    name = $('.statsPlayerName').text() || undefined;
                    ign = $('.context-item-name').text();
                    image = $('.context-item-image').attr('src');
                    getInfo = function (i) {
                        return $($('.divided-row')
                            .find('.large-strong')
                            .get(i));
                    };
                    age = Number(getInfo(1).text()) || undefined;
                    country = {
                        name: getInfo(2).text(),
                        code: parsing_1.popSlashSource($('.image-and-label .flag')).split('.')[0]
                    };
